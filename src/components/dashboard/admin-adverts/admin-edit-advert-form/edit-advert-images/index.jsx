...
import { createAdminImageAction, createImageAction } from "@/actions/image-action";


const DashboardEditAdvertImage = ({advertData}) => {
  const{id}=advertData
  const [state, dispatch] = useFormState(createAdminImageAction, initialResponse);
...
export default DashboardEditAdvertImage;
